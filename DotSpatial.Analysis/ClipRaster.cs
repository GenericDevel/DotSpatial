    ...
    public static class ClipRaster
    {
        ...
        public static IRaster ClipRasterWithPolygon(IFeature polygon, IRaster input, string outputFileName, ICancelProgressHandler cancelProgressHandler = null)
        {
            ...
            for (int columnCurrent = columnStart; columnCurrent < output.NumColumns; columnCurrent++)
            {
                ...
                // cancel if requested
                if (cancelProgressHandler != null && cancelProgressHandler.Cancel) return null;
            }
        ...
        /// <returns>Index of the first raster column to process.</returns>
        ...
        /// <param name="xMinRaster">The lowest left coordinate of the raster.</param>
        /// <param name="cellWidth">Size of the cell.</param>
        /// <returns>X coordinate of the first raster column to process.</returns>
        ...
        /// <returns>Y coordinate of the first raster row to process.</returns>
        ...
        private static List<Border> GetBorders(IFeature feature)
        {
            ...
            for (int i = 0; i < feature.Geometry.Coordinates.Length - 1; i++)
            {
                ...
                if (border.X1 != border.X2) borders.Add(border);
            }
        ...
        private static int GetStartColumn(IFeature polygon, IRaster inputRaster)
        {
            ...
            if (polygon.Geometry.EnvelopeInternal.MinX < rasterMinXCenter) return 0;
        ...
        private static double GetXStart(IFeature polygon, IRaster inputRaster)
        {
            ...
            // Does the poly sit to the left of the raster or does the raster start before the left edge of the poly
            if (polygon.Geometry.EnvelopeInternal.MinX < rasterMinXCenter) return rasterMinXCenter;
        ...
        /// <returns>The Y intersections.</returns>
        ...
        /// <param name="yMinRaster">The lowest left coordinate of the raster.</param>
        /// <param name="cellHeight">Size of the cell.</param>
        /// <returns>The Index of the first raster row to process.</returns>
